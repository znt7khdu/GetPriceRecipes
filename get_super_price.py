...
def get_info(threadurl,endurl):
    ...
    listnum = re.sub('äYìñè§ïiÅF','',listnum,flags=re.MULTILINE)
    listnum = int(listnum)
...
if __name__ == "__main__":
    ...
    urllist = ["https://www.the-seiyu.com/front/app/catalog/list/init?searchWord=&searchMethod=0&searchContextPath=%2Ffront&selectSlot=&selectSlot2=&mode=image&pageSize=49&currentPage=1&alignmentSequence=2&resultMessage=&searchUnitPrice=1,90"\
...
,"https://www.the-seiyu.com/front/app/catalog/list/init?searchWord=&searchMethod=0&searchContextPath=%2Ffront&selectSlot=&selectSlot2=&mode=image&pageSize=49&currentPage=1&alignmentSequence=2&resultMessage=&searchUnitPrice=1501,10000"]
    ...
    eurllist = ["&alignmentSequence=2&resultMessage=&searchUnitPrice=1,90"\
...
,"&alignmentSequence=2&resultMessage=&searchUnitPrice=1501,10000"]
    ...
    for x in range(0,len(aNAME)):
        ...
        cur.execute("""INSERT INTO test.price (NAME,SUB,PRICE,ICON_IMG) VALUES (%s, %s, %s, %s);""",arg)
        con.commit()
